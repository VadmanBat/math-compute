...
namespace nrcki {
class HighThreshold final : public Block {
...
public:
    explicit HighThreshold(const Context& context, const Type& activation_threshold, const Type& deactivation_delta) :
        Block(context),
